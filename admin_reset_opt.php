	...
	<body>
		<div class="container contact-form">
			...
			<div class="col-md-3" style="margin-left: 35%">
				<form method="POST" action="/cms/reset_done.php">
				<div class="form-group">
					<label style="color: white">Registration No.</label>
					<?php $reg=$_SESSION['reg_no']; print "<input type=\"text\" class=\"form-control\" name=\"reg_no\" required=\"\" value=\"$reg\">";?>
				</div>
				<div class="form-group">
					<label style="color: white">Student Name</label>
					<?php $name=$_SESSION['name']; print "<input type=\"text\" class=\"form-control\" name=\"name\" required=\"\" value=\"$name\">";?>
				</div>
				<div class="form-group">
