	...
	<body>
		<div class="container contact-form">
			...
			<div class="row" style="padding-left: 15%">
				...
				<a href="#" class="btn btn-success btn-lg disabled" role="button">Resolve</a>&nbsp;
			...
			<div class="container" style="padding-left: 35%">
				<form class="form-inline" role="form" method="POST" action="/cms/find.php">
